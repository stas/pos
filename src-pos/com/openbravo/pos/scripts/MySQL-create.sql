...
CREATE TABLE CUSTOMERS (
    ...
    SHIPPINGPOSTAL VARCHAR(255),
    SHIPPINGCITY VARCHAR(255),
    SHIPPINGREGION VARCHAR(255),
    ...
    CURDATE DATETIME,
    CURDEBT DOUBLE,
    DEBTDATELIMIT VARCHAR(255) NULL,
    DEBTMODE VARCHAR(255) NULL,
...
CREATE TABLE TICKETS (
    ...
    DUEDATE DATETIME DEFAULT '1990-01-01 09:00:00' NOT NULL,
    PRIMARY KEY (ID),
...
CREATE TABLE TICKETSNUM_SUPPLIER (ID INTEGER NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;
INSERT INTO TICKETSNUM_SUPPLIER VALUES(1);
