...
CREATE TABLE CUSTOMERS (
    ...
    SHIPPINGADDRESS VARCHAR(1024),
    SHIPPINGADDRESS2 VARCHAR(1024),
    SHIPPINGPOSTAL VARCHAR(1024),
    SHIPPINGCITY VARCHAR(1024),
    SHIPPINGREGION VARCHAR(1024),
    SHIPPINGCOUNTRY VARCHAR(1024),
    ...
    DEBTDATELIMIT VARCHAR(256),
    DEBTMODE VARCHAR(1024),
    COMPANYNAME VARCHAR(256),
    CUI VARCHAR(256),
    NRREG VARCHAR(256),
    COMPANYNOTE VARCHAR(256),
    PRIMARY KEY (ID),
...
CREATE TABLE TAXES (
    ...
    VALIDFROM TIMESTAMP DEFAULT '2000-01-01 00:00:00' NOT NULL,
...
CREATE TABLE TICKETS (
    ...
    DUEDATE TIMESTAMP DEFAULT '1990-01-01 00:00:00' NOT NULL,
    PRIMARY KEY (ID),
...
CREATE TABLE TICKETSNUM_SUPPLIER (ID INTEGER GENERATED) ALWAYS AS IDENTITY (START WITH 1));
INSERT INTO TICKETSNUM_SUPPLIER VALUES (DEFAULT);
...
CREATE TABLE PAYMENTS (
    ...
    RETURNMSG BLOB,
    CHEQUENUMBER VARCHAR(256),
    BANKNAME VARCHAR(1024),
    CHEQUEDATE VARCHAR(1024),
    TICKETID VARCHAR(1024),
    SUPPLIERID VARCHAR(1024),
    PRIMARY KEY (ID),
